...
import com.iplT20.models.MatchStatus;
import com.iplT20.models.User;
import com.iplT20.models.UserMatch;
import com.iplT20.service.MatchService;
		...
		if (list != null) {
			for (Object tableData : list) {
				...
				if (userFlag.equals("N")
					...
					result.put("adjustButtonFlag",
							checkMatchAdjustmentStatus(Integer.parseInt(result
									.get("id"))));
				}
				if (userFlag.equals("N")
						&& Integer.parseInt(result.get("id")) <= 30) {
